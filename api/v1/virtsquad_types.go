...
type VirtSquad struct {
	...
	// spec defines the desired state of VirtSquad
	// +required
	Spec VirtSquadSpec `json:"spec"`

	// status defines the observed state of VirtSquad
	// +optional
	Status VirtSquadStatus `json:"status,omitempty,omitzero"`
}
